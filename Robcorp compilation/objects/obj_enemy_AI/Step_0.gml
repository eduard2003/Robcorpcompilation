...
/// @DnDVersion : 1
/// @DnDHash : 1C6809ED
/// @DnDArgument : "code" "if instance_number(obj_player1) == true{$(13_10)	speed = speed_enemy$(13_10)	direction = point_direction(x,y,obj_player1.x,obj_player1.y);$(13_10)	if !collision_line(x,y,obj_player1.x,obj_player1.y,obj_collider,true,true){$(13_10)		if distance_to_object (obj_player1) < 20{$(13_10)			speed_enemy = 0;$(13_10)		}$(13_10)		else{$(13_10)			speed_enemy = 4;$(13_10)			if(cooldown_enemy <= 0){$(13_10)				instance_create_layer(x,y,"Layer_bullet",obj_enemybullet);$(13_10)				cooldown_enemy = 7$(13_10)			}$(13_10)		cooldown_enemy -= 1$(13_10)		}$(13_10)	}$(13_10)	else{$(13_10)		speed_enemy = 0;$(13_10)		image_angle = 0;$(13_10)	}$(13_10)}$(13_10)$(13_10)if hp_enemy <= 0{$(13_10)	instance_destroy();$(13_10)}"
if instance_number(obj_player1) == true{
	speed = speed_enemy
	direction = point_direction(x,y,obj_player1.x,obj_player1.y);
	if !collision_line(x,y,obj_player1.x,obj_player1.y,obj_collider,true,true){
